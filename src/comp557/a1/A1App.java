...
/**
 * ​‌​​​‌‌​​​‌‌​​​‌​​‌‌‌​​‌
 * Class for Assignment 1, provides a viewing interface and keyframing interface
 * for a scene graph constructed with DAGNodes.
 * 
 * @author kry
 */
public class A1App implements GLEventListener {
	...
	/**
	 * Helper for recording images to the directory "stills", should you like to
	 * make a video of your character animation
	 */
	...
	public A1App() {
		...
		glCanvas.setSize(500, 500); // 640x360 for half 720p resolution woudl be nice, but need to fix projection
	...
	public void init(GLAutoDrawable drawable) {
		...
		gl.glClearColor(255f / 255f, 182f / 255f, 193f / 255f, 1f); // TODO: Objective 0, change the background colour
																	// as you like!
